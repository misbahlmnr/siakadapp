...
import type { BreadcrumbItem, MatPel, MateriPelajaran } from '@/types';
...
const selectedMatpelLabel = ref('Pilih Mapel');
...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'Tambah Rule', href: route('admin.adaptive-rules.create') },
];

const submit = () => {
    form.post(route('admin.adaptive-rules.store'));
};
</script>
...
<template>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex flex-col gap-4 px-10 py-6">
            <h1 class="text-2xl font-bold">Tambah Adaptive Rule</h1>
