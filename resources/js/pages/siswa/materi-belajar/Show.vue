        ...
        <div class="space-y-6 p-6">
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                        Pertemuan {{ materi.pertemuan_ke }} - {{ materi.jadwal.mata_pelajaran.nama_mapel }}
                    </p>
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <div class="space-y-6 lg:col-span-2">
                    ...
                    <!-- File Materi -->
                    <div v-if="materi.file_materi" class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                    ...
                    <!-- Link Materi -->
                    <div v-if="materi.link_materi" class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
                        ...
                        <div class="flex items-center space-x-3">
                            <div class="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 dark:bg-blue-900">
                                <span class="font-semibold text-blue-800 dark:text-blue-300">
                                    {{ materi.jadwal.guru.user.name.charAt(0) }}
                                </span>
                            </div>
                            <div>
                                <p class="text-sm font-medium text-gray-900 dark:text-white">
                                    {{ materi.jadwal.guru.user.name }}
                                </p>
                                <p class="text-xs text-gray-500 dark:text-gray-400">Guru {{ materi.jadwal.mata_pelajaran.nama_mapel }}</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-2">
                            <div class="flex justify-between">
                                ...
                                <span class="text-sm font-medium text-gray-900 dark:text-white">
                                    {{ materi.jadwal.mata_pelajaran.nama_mapel }}
                                </span>
                            </div>
                            <div class="flex justify-between">
                                <span class="text-sm text-gray-600 dark:text-gray-400">Kode Mapel</span>
                                <span class="text-sm font-medium text-gray-900 dark:text-white">
                                    {{ materi.jadwal.mata_pelajaran.kode_mapel }}
                                </span>
                            </div>
                            <div class="flex justify-between">
