...
onMounted(() => {
    useDataTable('#adaptive-rules-table', {
        ajax: route('guru.adaptive-rules.data'),
        editRoute: 'guru.adaptive-rules.edit',
        deleteRoute: 'guru.adaptive-rules.destroy',
        columns: [
        ...
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl px-10 py-4">
            <div class="flex items-center justify-between">
                ...
                <Button
                    ...
                    @click="router.visit(route('guru.adaptive-rules.create'))"
                >
